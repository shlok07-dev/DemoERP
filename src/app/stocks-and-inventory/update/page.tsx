...
export default function UpdateStockPage() {
  ...
  return (
    <div>
      <PageHeader title="Add New Stock Item" subtitle="Add new consumable items to your stock inventory" />
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50 p-4">
          <div className="bg-white rounded-lg p-8 max-w-md w-full text-center">
            ...
            <p className="text-gray-600 mb-6">Your inventory has been updated successfully.</p>
